...
class Belief:
    ...
    The belief of the agent. it contains 
        1. events: the events oberseved by the agent, syncronized with the shared memory
        2. internal_events: the internal events generated by the agent through the reasoning process (actions)
    """
