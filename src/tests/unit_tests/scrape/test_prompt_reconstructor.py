...
def mock_get_link_from_slack_client_conversation():
    return [
        {"url": "https://google.com", "base_url": "https://google.com"}
    ]  # Replace with the desired mocked result
...
def test_reconstruct_prompt_with_link_inside_succeeds(
    ...
    assert (
        ...
        == f"""Here's a [1]./n Reference: [1] link: "https://google.com" , link_data: [{{'data': '{mock_chunk_and_summarize}', 'link': 'https://google.com'}}]"""
    )
