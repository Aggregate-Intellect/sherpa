...
A 73-year-old bottle of French Burgundy became the most expensive bottle of wine ever sold at auction in 2018, going for $558,000 (approx £439,300). The bottle of 1945 Romanee-Conti sold at Sotheby for more than 17 times its original estimate of $32,000."""  # noqa E501
session_id = "6"
meta_data = {
...
def test_shared_memory_with_vector(get_llm, mock_chroma_vector_store):  # noqa F811
    ...
    task_agent = QAAgent(
        llm=llm, shared_memory=shared_memory, do_synthesize_output=True
    )
